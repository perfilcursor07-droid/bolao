...
const { getMatchScorers, hasMatchScorers, parseScorerEntry, formatScorerTag } = require('./utils/matchScorers');
...
app.use(async (req, res, next) => {
  ...
  res.locals.getMatchScorers = getMatchScorers;
  res.locals.hasMatchScorers = hasMatchScorers;
  res.locals.parseScorerEntry = parseScorerEntry;
  res.locals.formatScorerTag = formatScorerTag;
